  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">351 Dhaka Mohakhali, Road-2</p>
      ...
      <p id="copyright">Copyright &copy; 2022 <a href="https://macodeid.com/" target="_blank">LaravelCode ID</a>. All right reserved</p>
    </div>
  </footer>
