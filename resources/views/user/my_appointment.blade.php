...
<div align="center" style="padding:70px">
  <table>
     ...
     <th style="padding:10px; fornt-size: 20px; color:white;">Doctor Name</th>
     <th style="padding:10px; fornt-size: 20px; color:white;">Date</th>
     <th style="padding:10px; fornt-size: 20px; color:white;">Message</th>
     <th style="padding:10px; fornt-size: 20px; color:white;">Status</th>
     
     <th style="padding:10px; fornt-size: 20px; color:white;">Cancel Appointment</th>
     </tr>
